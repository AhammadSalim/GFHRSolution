...
namespace GFHRSolution.Controllers
{
    ...
    {
        private readonly GFHRSolutionContext _context;

        public DesignationsController(GFHRSolutionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Designation1,Code")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Designation1,Code")] Designation designation)
        {
